...
int main(int argc, char** argv) {
    ...
    nh.param("UpdateFrequency", UpdateFrequency, 30);
    ...
    RivalOdom_Pub[0] = nh.advertise<nav_msgs::Odometry>("/rival/final_pose", 100);
    ...
    Rival[0].Position.position.y = 0.6;
    ...
    while (nh.ok()) {
        ...
        if (RivalNum == 2) {
            ...
            // Header
            RivalOdom_msg.header.frame_id = RobotName + "/map";
