...
// 
   private:
    ...
    ros::Publisher after_integrate_pub_;
    ...
    // Client
    ros::ServiceClient fast_mode_client_;
    ...
    double no_pursuit_y_dis_;
    double no_pursuit_rad_tolerance_;
    double nearest_dis_to_goal_;
    bool no_pursuit_activate_;
    ...
    // FAST SPIN MODE
    double fast_spin_tolerance_;
    double fast_spin_kp_;
    double fast_spin_limit_;
    bool fast_spin_enable_;
    ...
    // Debounce for goal reached
    int XY_reached_cnt_;
    int Theta_reached_cnt_;
